package com.wetsion.study.algorithm;
...
public class DecisionTree {
    public static void main(String[] args) throws Exception {
        ...
        String[] attrNames = new String[] { "色泽", "根蒂", "敲声", "纹理", "脐部", "触感" };
        // 读取样本集
    ...
    static Map<Object, List<Sample>> readSamples(String[] attrNames) {
        ...
        Object[][] rawData = new Object[][] { { "青绿", "蜷缩", "浊响", "清晰", "凹陷", "硬滑", "是" },
                { "乌黑", "蜷缩", "沉闷", "清晰", "凹陷", "硬滑", "是" }, { "乌黑", "蜷缩", "浊响", "清晰", "凹陷", "硬滑", "是" },
                { "青绿", "蜷缩", "沉闷", "清晰", "凹陷", "硬滑", "是" }, { "浅白", "蜷缩", "浊响", "清晰", "凹陷", "硬滑", "是" },
                { "青绿", "稍蜷", "浊响", "清晰", "稍凹", "软黏", "是" }, { "乌黑", "稍蜷", "浊响", "稍糊", "稍凹", "软黏", "是" },
                { "乌黑", "稍蜷", "浊响", "清晰", "稍凹", "硬滑", "是" }, { "乌黑", "稍蜷", "沉闷", "稍糊", "稍凹", "硬滑", "否" },
                { "青绿", "硬挺", "清脆", "清晰", "平坦", "软黏", "否" }, { "浅白", "硬挺", "清脆", "模糊", "平坦", "硬滑", "否" },
                { "浅白", "蜷缩", "浊响", "模糊", "平坦", "软黏", "否" }, { "青绿", "稍蜷", "浊响", "稍糊", "凹陷", "硬滑", "否" },
                { "浅白", "稍蜷", "沉闷", "稍糊", "凹陷", "硬滑", "否" }, { "乌黑", "稍蜷", "浊响", "清晰", "稍凹", "软黏", "否" },
                { "浅白", "蜷缩", "浊响", "模糊", "平坦", "硬滑", "否" }, { "青绿", "蜷缩", "沉闷", "稍糊", "稍凹", "硬滑", "否" } };
...
//        System.out.println((Map<Object, Map<Object, List<Sample>>>)rst[2]);
        log.info("rst2: [{}]", rst[2]);
    ...
    /**
     * 选取最优测试属性。最优是指如果根据选取的测试属性分支，则从各分支确定新样本 的分类需要的信息量之和最小，这等价于确定新样本的测试属性获得的信息增益最大
